...
bin/spark-submit --master spark://127.0.0.1:7077 --class ArticlesGeoRef --conf spark.akka.frameSize=200 --conf spark.cassandra.connection.host=127.0.0.1 /home/akmoch/dev/build/my-scala-spark/target/scala-2.10/my-spark-cassandra-assembly-1.0-SNAPSHOT.jar
